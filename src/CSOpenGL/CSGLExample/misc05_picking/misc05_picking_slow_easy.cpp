...
#define CSGL_Demo_Misc05_Picking_Slow_Easy "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/misc05_picking/"
int CSGL_Demo_misc05_Picking_Slow_Easy( void )
{
	// Initialise GLFW
	if( !glfwInit() )
	{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Misc05_Picking_Slow_Easy"StandardShading.vertexshader", \
                                   CSGL_Demo_Misc05_Picking_Slow_Easy"StandardShading.fragmentshader" );
	GLuint pickingProgramID = LoadShaders( CSGL_Demo_Misc05_Picking_Slow_Easy"Picking.vertexshader", \
                                          CSGL_Demo_Misc05_Picking_Slow_Easy"Picking.fragmentshader" );
	...
	// Load the texture
	GLuint Texture = loadDDS(CSGL_Demo_Misc05_Picking_Slow_Easy"uvmap.DDS");
	...
	bool res = loadOBJ(CSGL_Demo_Misc05_Picking_Slow_Easy"suzanne.obj", vertices, uvs, normals);
