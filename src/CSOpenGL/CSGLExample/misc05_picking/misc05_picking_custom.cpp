...
#define CSGL_Demo_Misc05_Picking_Custom "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/misc05_picking/"
...
int CSGL_Demo_misc05_Picking_Custom( void )
{
	// Initialise GLFW
	if( !glfwInit() )
	{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Misc05_Picking_Custom"StandardShading.vertexshader", \
                                   CSGL_Demo_Misc05_Picking_Custom"StandardShading.fragmentshader" );
	...
	// Load the texture
	GLuint Texture = loadDDS(CSGL_Demo_Misc05_Picking_Custom"uvmap.DDS");
	...
	bool res = loadOBJ(CSGL_Demo_Misc05_Picking_Custom"suzanne.obj", vertices, uvs, normals);
