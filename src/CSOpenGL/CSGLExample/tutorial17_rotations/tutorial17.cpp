...
#define CSGL_Demo_Tutorial17_Root_Path "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/tutorial17_rotations/"
...
int CSGL_Demo_Tutorial17( void )
{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Tutorial17_Root_Path"StandardShading.vertexshader", \
                                   CSGL_Demo_Tutorial17_Root_Path"StandardShading.fragmentshader" );
	...
	// Load the texture
	GLuint Texture = loadDDS(CSGL_Demo_Tutorial17_Root_Path"uvmap.DDS");
	...
	bool res = loadOBJ(CSGL_Demo_Tutorial17_Root_Path"suzanne.obj", vertices, uvs, normals);
