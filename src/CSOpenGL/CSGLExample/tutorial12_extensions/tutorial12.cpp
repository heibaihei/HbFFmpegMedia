...
#define CSGL_Demo_Tutorial13_Root_Path "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/tutorial12_extensions/"
...
int CSGL_Demo_Tutorial12( void )
{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Tutorial13_Root_Path"StandardShading.vertexshader", \
                                    CSGL_Demo_Tutorial13_Root_Path"StandardShading_WithSyntaxErrors.fragmentshader" );
	...
	// Load the texture
	GLuint Texture = loadDDS(CSGL_Demo_Tutorial13_Root_Path"uvmap.DDS");
	...
	bool res = loadOBJ(CSGL_Demo_Tutorial13_Root_Path"suzanne.obj", vertices, uvs, normals);
