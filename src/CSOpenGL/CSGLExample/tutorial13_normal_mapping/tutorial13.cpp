...
#define CSGL_Demo_Tutorial13_Root_Path "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/tutorial13_normal_mapping/"

int CSGL_Demo_Tutorial13( void )
{
	// Initialise GLFW
	if( !glfwInit() )
	{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Tutorial13_Root_Path"NormalMapping.vertexshader", \
                                   CSGL_Demo_Tutorial13_Root_Path"NormalMapping.fragmentshader" );
	...
	// Load the texture
	GLuint DiffuseTexture = loadDDS(CSGL_Demo_Tutorial13_Root_Path"diffuse.DDS");
	GLuint NormalTexture = loadBMP_custom(CSGL_Demo_Tutorial13_Root_Path"normal.bmp");
	GLuint SpecularTexture = loadDDS(CSGL_Demo_Tutorial13_Root_Path"specular.DDS");
	...
	bool res = loadOBJ(CSGL_Demo_Tutorial13_Root_Path"cylinder.obj", vertices, uvs, normals);
