...
#define CSGL_Demo_Tutorial09_Several_Objects_Root_Path "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/tutorial09_vbo_indexing"

int CSGL_Demo_Tutorial09_Several_Objects( void )
{
	// Initialise GLFW
	if( !glfwInit() )
	{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Tutorial09_Several_Objects_Root_Path"/StandardShading.vertexshader", \
                                   CSGL_Demo_Tutorial09_Several_Objects_Root_Path"/StandardShading.fragmentshader" );
	...
	// Load the texture
	GLuint Texture = loadDDS(CSGL_Demo_Tutorial09_Several_Objects_Root_Path"/uvmap.DDS");
	...
	bool res = loadOBJ(CSGL_Demo_Tutorial09_Several_Objects_Root_Path"/suzanne.obj", vertices, uvs, normals);
