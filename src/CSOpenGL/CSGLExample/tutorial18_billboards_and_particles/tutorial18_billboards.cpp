...
#define CSGL_Demo_Tutorial18_Billboards_Root_Path "/Users/zj-db0519/work/code/github/HbFFmpegMedia/src/CSOpenGL/CSGLExample/tutorial18_billboards_and_particles/"

#define DRAW_CUBE // Comment or uncomment this to simplify the code

int CSGL_Demo_Tutorial18_billboards( void )
{
	// Initialise GLFW
	if( !glfwInit() )
	{
	...
	GLuint programID = LoadShaders( CSGL_Demo_Tutorial18_Billboards_Root_Path"Billboard.vertexshader", \
                                   CSGL_Demo_Tutorial18_Billboards_Root_Path"Billboard.fragmentshader" );
	...
	GLuint Texture = loadDDS(CSGL_Demo_Tutorial18_Billboards_Root_Path"ExampleBillboard.DDS");
	...
	GLuint cubeProgramID = LoadShaders( CSGL_Demo_Tutorial18_Billboards_Root_Path"../tutorial04_colored_cube/TransformVertexShader.vertexshader", \
                                       CSGL_Demo_Tutorial18_Billboards_Root_Path"../tutorial04_colored_cube/ColorFragmentShader.fragmentshader" );
