...
int audio_format_convert_demo(int argv, char* argc[])
{
    char* filename = "/Users/zj-db0519/Desktop/material/folder/video/ssy03.mov";
    ...
    wanted_spec.userdata = pCodecCtx; // 作为回调的参数
