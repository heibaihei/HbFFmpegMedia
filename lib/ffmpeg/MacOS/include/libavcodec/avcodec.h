...
typedef struct AVPacket {
     ...
     *//** 相邻两个包的时间差,例如对于mp3，44100采样率，1152点/帧，duration =26; 视频帧率为25，duration = 40 */
    int64_t duration;
...
typedef struct AVCodecContext {
    ...
    enum AVMediaType codec_type; /* see AVMEDIA_TYPE_xxx , 媒体类型*/
    ...
    char             codec_name[32];
#endif
    enum AVCodecID     codec_id; /* see AV_CODEC_ID_xxx , 音视频编解码类型 */
